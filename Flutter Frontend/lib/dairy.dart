              ...
              child: Container(
                child: Row(
                  ...
                  children: <Widget>[
                    Column(
                      children: <Widget>[
                        _buildFruitCard("Milk", "images/milk.png","₹56", 0xffF7DFB9, 0XffFAF0DA),
                        ...
                        SizedBox(height: 2 * SizeConfig.heightMultiplier,),
                        _buildFruitCard("Cheese", "images/cheese.png","₹350", 0xffF6E475, 0XffF9EFB0),
                      ],
                    ),
                    Spacer(),
                    Column(
                      children: <Widget>[
                        ...
                        SizedBox(height: 2 * SizeConfig.heightMultiplier,),
                        _buildFruitCard("Butter", "images/butter.png","₹490", 0xffFFC498, 0XffFDDCC1),
                        SizedBox(height: 2 * SizeConfig.heightMultiplier,),
                        _buildFruitCard("Cream", "images/cream.png","₹195", 0xffF0AEAF, 0XffF8C6CA),
                        SizedBox(height: 2 * SizeConfig.heightMultiplier,),
                      ],
                    )
                  ],
