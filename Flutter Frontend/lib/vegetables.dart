              ...
              child: Container(
                child: Row(
                  ...
                  children: <Widget>[
                    Column(
                      children: <Widget>[
                        _buildFruitCard("Potato", "images/Potato.png","₹25", 0xffF7DFB9, 0XffFAF0DA),
                        ...
                        SizedBox(height: 2 * SizeConfig.heightMultiplier,),
                        _buildFruitCard("Cucumber", "images/cucumber.png","₹40", 0xffF6E475, 0XffF9EFB0),
                      ],
                    ),
                    Spacer(),
                    Column(
                      children: <Widget>[
                        ...
                        SizedBox(height: 2 * SizeConfig.heightMultiplier,),
                        _buildFruitCard("Pumpkin", "images/pumpkin.png","₹40", 0xffFFC498, 0XffFDDCC1),
                        SizedBox(height: 2 * SizeConfig.heightMultiplier,),
                        _buildFruitCard("Carrot", "images/carrot.png","₹30", 0xffF0AEAF, 0XffF8C6CA),
                        SizedBox(height: 2 * SizeConfig.heightMultiplier,),
                      ],
                    )
                  ],
